...
<head>
    <meta charset="utf-8">
    <title>Pricing - AldeMedado Dental Clinic</title>
...
?>
    ...
    <!-- Hero Start -->
    <div class="container-fluid bg-success py-5 hero-header mb-5">
        <div class="row py-3">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-5">
                    ...
                    <h1 class="wow fadeInUp" data-wow-delay="0.6s">+639055955762</h1>
                </div>
                <div class="col-lg-7">
                        ...
                        ?>
                            <div class="price-item pb-4">
                                <div class="position-relative">
                                    <img class="img-fluid rounded-top" src="img/<?= $theprice['image'] ?>" style="height: 200px;" alt="">
                                    <div class="d-flex align-items-center justify-content-center bg-light rounded pt-2 px-3 position-absolute top-100 start-50 translate-middle" style="z-index: 2;">
                                        <h4 class="text-success m-0">₱ <?= number_format($theprice['price'], 2);?></h4>
                                    </div>
                                </div>
                                <div class="position-relative text-center bg-light border-bottom border-success py-5 p-4" style="max-height: 200px; height: 100%;">
                                    ...
                                    <a href="appointment.php?id=<?=$theprice['id'];?>" class="btn btn-success py-2 px-4 position-absolute top-100 start-50 translate-middle" style="width: 55%">Make Appointment</a>
                                </div>
                            </div>
                        <?php }} ?>
...
<!--                             <a href="appointment.php?id=<?=$val02['id']?>">
 ...
 -->                             <div class="position-relative">
                                    <img class="img-fluid rounded-top" src="img/<?= $val02['image'] ?>" style="height: 200px; width: 100%" alt="">
                                    <div class="d-flex align-items-center justify-content-center bg-light rounded pt-2 px-3 position-absolute top-100 start-50 translate-middle" style="z-index: 2;">
                                        <h3 class="text-success m-0">₱ <?= number_format($val02['price'], 2);?></h3>
                                    </div>
                                </div>
                                <div class="position-relative text-center bg-light border-bottom border-success py-5 p-4" style="max-height: 200px; height: 100%; margin-bottom: 50px;">
                                    <h4><?=$val02['service_name'];?></h4>
                                    <hr class="text-success w-50 mx-auto mt-0">
                                    <div class="d-flex justify-content-between mb-3" style="text-align: center;">
                                        <span><?=$val02['description'];?></span>
                                    </div>
                                    <a href="appointment.php?id=<?=$val02['id'];?>" class="btn btn-success py-2 px-4 position-absolute top-100 start-50 translate-middle">Make Appointment</a>
                                </div>
                        </div>
